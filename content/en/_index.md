...
{{< blocks/cover title="Welcome to Katzenpost" image_anchor="top" height="full" >}}
...
<p class="lead mt-5">We are creating traffic analysis resistant messaging</p>
...
{{% blocks/feature icon="fab fa-github" title="Contributions welcome!" url="https://github.com/katzenpost/katzenpost" %}}
We do a [Pull Request](https://github.com/katzenpost/katzenpost/pulls) contributions workflow on **GitHub**. New users are always welcome!
{{% /blocks/feature %}}
...
{{% blocks/feature icon="fab fa-github" title="Contributions welcome!"
    url="https://github.com/katzenpost/katzenpost" %}}
We do a [Pull Request](https://github.com/katzenpost/katzenpost/pulls)
