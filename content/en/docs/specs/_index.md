...
|----|----------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|
| 📖 | **[Pigeonhole Design Specification](/docs/specs/pigeonhole)**                         | Pigeonhole Design Specification.                                                                                     | [HTML](/docs/specs/pigeonhole)     |
| 📖 | **[Group Chat Design](/docs/specs/group_chat)**                         | Katzenpost Group Chat Design.                                                                                     | [HTML](/docs/specs/group_chat)     |
| 📖 | **[Contact Voucher Design](/docs/specs/contact_voucher)**                         | Contact Voucher Design.                                                                                     | [HTML](/docs/specs/contact_voucher)     |
...
| 📖 | **[Thin Client](/docs/specs/thin_client)**                                    | Thin client library design.                                                                                                            | [HTML](/docs/specs/thin_client)         |
